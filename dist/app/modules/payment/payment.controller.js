...
const initPyament = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield payment_service_1.PaymentService.initPyament(req.body);
...
exports.PaymentController = {
    initPyament, webhook, getAllFromDB, getByIdFromDB
};
