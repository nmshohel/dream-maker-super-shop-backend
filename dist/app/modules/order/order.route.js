...
router.delete('/:id', (0, auth_1.default)(ADMIN), order_controller_1.OrderController.deleteById);
router.patch('/:id', (0, auth_1.default)(ADMIN), order_controller_1.OrderController.updateIntoDB);
