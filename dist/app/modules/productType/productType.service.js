...
const product_constrant_1 = require("../product/product.constrant");
const inertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = prisma_1.default.productType.create({
        data: data,
    });
    return result;
});
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.productType.findMany({
    ...
    const total = yield prisma_1.default.productType.count();
    return {
        meta: {
            total,
            page,
...
const getDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.productType.findUnique({
        where: {
            id,
        },
    });
...
const deleteById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.productType.delete({
        where: {
            id,
        },
    });
...
const updateIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.productType.update({
        where: {
            id,
        },
        data: payload,
...
const getDataByProductType = () => __awaiter(void 0, void 0, void 0, function* () {
